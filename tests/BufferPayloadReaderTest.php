...
class BufferPayloadReaderTest extends TestCase
{
    ...
    public function testReadsOneByteFixedInteger()
    {
    ...
    public function testReadsMultipleBytesOfFixedInteger()
    {
    ...
    public function testReadsOneByteLengthEncodedInteger()
    {
    ...
    public function testReadsTwoByteLengthEncodedInteger()
    {
    ...
    public function testReadsThreeByteLengthEncodedInteger()
    {
    ...
    public function testReadsEightByteLengthEncodedInteger()
    {
        $payloadReader = $this->createPayloadReader(
    ...
    public function testReadsNullValueFromLengthEncodedIntegerSpec()
    {
    ...
    public function testReportsIncorrectLengthEncodedIntegerGivenFirstByteIsOutOfBounds()
    {
    ...
    public function testReadsLongLengthEncodedString()
    {
    ...
    public function testReadsNullStringValue()
    {
        $payloadReader = $this->createPayloadReader("\xfb");
    ...
    public function testReadsNullTerminatedString()
    {
    ...
    public function testThrowsIncompleteBufferExceptionWhenNullCharacterIsNotPresent()
    {
    ...
    public function testReadsStringTillEndOfTheBuffer()
    {
    ...
    public function testReadsMultipleStringsThatRepresentCompletePacket()
    {
        $payloadReader = $this->createPayloadReader(
    ...
    public function testReadsRestOfPacketStringStartingFromCurrentBufferPosition()
    {
        $payloadReader = $this->createPayloadReader(
